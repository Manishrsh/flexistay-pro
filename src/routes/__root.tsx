...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "ScaleGym | Gym Management System" },
      {
        name: "description",
        content:
          "All-in-one gym management: members, memberships, attendance, trainers, workouts, payments, expenses, inventory, leads and reports.",
      },
      { property: "og:title", content: "ScaleGym | Gym Management System" },
      {
        property: "og:description",
        content: "Run your gym end-to-end: members, plans, attendance, payments, staff and reports.",
      },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:title", content: "ScaleGym | Gym Management System" },
